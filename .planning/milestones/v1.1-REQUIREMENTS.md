# Requirements Archive: v1.1 World & Growth Overhaul

**Archived:** 2026-03-07
**Status:** SHIPPED

A fresh `.planning/REQUIREMENTS.md` should be created by `$gsd-new-milestone` before planning the next shipped scope.
